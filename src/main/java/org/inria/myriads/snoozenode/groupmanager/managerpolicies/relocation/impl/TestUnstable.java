 ...
 * @author Eugen Feller
 */
public final class TestUnstable 
    implements VirtualMachineRelocation 
{
    /** Define the logger. */
    private static final Logger log_ = LoggerFactory.getLogger(TestUnstable.class);
     ...
     */
    public TestUnstable(ResourceDemandEstimator estimator)
    {
        Guard.check(estimator);
        estimator_ = estimator;
        log_.debug("Unstable relocation policy started");
    }
